...
Datastore.prototype.getFilename = function(fetcher, queueItem) {
  return this.saveTo + fetcher + '.jsontape';
};

Datastore.prototype.add = function (fetcher, queueItem, data, callback) {
  fs.appendFile(
    this.getFilename(fetcher, queueItem),
